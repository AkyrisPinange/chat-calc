...
public class WebSocketController {
    ...
    @MessageMapping("/chat/{chatId}/joinChat") // endpoint WebSocket
    ...
    @MessageMapping("/chat/{chatId}/sendMessage") // endpoint WebSocket
    @SendTo("/topic/chat/{chatId}")// endpoint webSocket
