...
$("#connect").on('click', (e) => {
    ...
    stompClient.connect({
        'Authorization': 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJwYXVsby5ndWlsaGVybWUuYXJydWRhMUBnbWFpbC5jb20iLCJpYXQiOjE3MTc4NjU3ODMsImV4cCI6MTcyNzg4OTg0M30.jXMr692_XK7waULU2k5SOFr8eNIZAD7w_6IzToOnDR8',
    }, function (frame) {
